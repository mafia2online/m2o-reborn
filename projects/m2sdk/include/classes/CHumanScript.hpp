...
namespace M2
{
	...
	public:
        ...
        C_SyncObject *ScrAimAt(C_SyncObject **syncObject, M2::C_Entity *ent, Vector3 const &pos, const bool smooth);
        C_SyncObject *ScrLookAt(C_SyncObject **syncObject, M2::C_Entity *ent, Vector3 const &pos, const bool smooth);
        C_SyncObject *ScrLookAtAngles(C_SyncObject **syncObject, M2::C_Entity *ent, float x, float y, float z);
        C_SyncObject *ScrLookAtDir(C_SyncObject **syncObject, M2::C_Entity *ent, Vector3 const &pos);
        C_SyncObject *ScrMoveV(C_SyncObject **syncObject, const Vector3 &begin, const eHumanMoveMode moveMode, const Vector3 &target, const bool smoothStop);
        C_SyncObject *ScrShootAt(C_SyncObject **syncObject, M2::C_Entity *ent, Vector3 const &dir, const bool smooth);
        C_SyncObject *ScrPanicRunAway(C_SyncObject **syncObject, const Vector3 &dir);
