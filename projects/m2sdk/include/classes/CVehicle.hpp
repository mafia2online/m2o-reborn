...
namespace M2
{
	...
	public:
        ...
        void GetVehicleColor(Vector3 *const primary, Vector3 *const secondary)
        {
        ...
        void SetVehicleColor(const Vector3 primary, const Vector3 secondary)
        {
