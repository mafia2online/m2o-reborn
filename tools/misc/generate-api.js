// m2o server api generator
// start from the root folder: $ node generate-api.js
...
const targets = [
    'code/shared/m2o_config.h',
    'code/server/core/api/general.h',
    'code/server/core/api/vehicle.h',
    'code/server/core/api/player.h',
    'code/server/core/api/pedestrian.h',
];

const publicOutput = 'bin/m2o_api.h'
const internOutput = 'code/server/core/api/vtable.h'
