namespace tools {
    ...
    twoaddrs steam_drm__generatorlist[] = {
        { 0xdd83d0, 0xb3ed14b5 },
        { 0xdd8600, 0x9d613e7f },
        { 0xdd8830, 0xf5da4a8d },
        { 0xdd8a60, 0x871ad839 },
    ...
    twoaddrs steam_drm__jpmpatches2[] = {
        { 0x41a450, 0x12b },
        { 0x420080, 0xda3b },
        { 0x448500, 0x400eb },
        { 0x448900, 0x24c6b },
    ...
    void steam_drm_install()
    {
        for (auto patchaddr : steam_drm__jmppatches)
        {
        ...
        for (auto& genent : steam_drm__generatorlist)
        {
        ...
        for (auto& jmpent : steam_drm__jpmpatches2)
        {
