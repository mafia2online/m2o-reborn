...
namespace ue::sys::filesystem {
	...
	public:
        ...
        /*8*/   virtual int32_t Done(void) = 0;
        /*12*/  virtual int32_t SetWriteDir(char const*) = 0;
        /*16*/  virtual int32_t SetWriteDirVFS(char const*) = 0;
        /*20*/  virtual int32_t GetWriteDir(void) = 0;
        /*24*/  virtual int32_t PushWriteDir(void) = 0;
        /*28*/  virtual int32_t PopWriteDir(void) = 0;
        ...
        /*56*/  virtual int32_t Mount(char const*, char const*, int) = 0;
        /*60*/  virtual int32_t Mount(char const*, int) = 0;
        /*64*/  virtual int32_t Mount2(char const*, char const*, char const*) = 0;
        /*68*/  virtual bool Unmount(char const*) = 0;
        /*72*/  virtual int32_t UnmountAll(void) = 0;
        ...
        /*120*/ virtual int32_t EnumFilesWildcard(char const*, char const*, int) = 0;
