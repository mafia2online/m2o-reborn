...
void title_state_render()
{
    ...
    auto iFontHeight = fm->GetFontHeight(*font) + 5; // lawl +5

    if (font != nullptr) {
        int iYOffset = iScreenH - 50;

        fm->DrawTextA("Q", 25, iYOffset, D3DCOLOR_XRGB(179, 48, 48), *font, true);
        fm->DrawTextA("uit", 25 + fm->GetTextWidthA(*font, "Q"), iYOffset, D3DCOLOR_XRGB(255, 255, 255), *font, true);
        iYOffset -= iFontHeight;

        fm->DrawTextA("S", 25, iYOffset, D3DCOLOR_XRGB(179, 48, 48), *font, true);
        fm->DrawTextA("ettings", 25 + fm->GetTextWidthA(*font, "S"), iYOffset, D3DCOLOR_XRGB(255, 255, 255), *font, true);
        iYOffset -= iFontHeight;

        fm->DrawTextA("F", 25, iYOffset, D3DCOLOR_XRGB(179, 48, 48), *font, true);
        fm->DrawTextA("ind Servers", 25 + fm->GetTextWidthA(*font, "F"), iYOffset, D3DCOLOR_XRGB(255, 255, 255), *font, true);
        iYOffset -= iFontHeight;

        fm->DrawTextA("Q", 25, iYOffset, D3DCOLOR_XRGB(179, 48, 48), *font, true);
        fm->DrawTextA("uick connect", 25 + fm->GetTextWidthA(*font, "Q"), iYOffset, D3DCOLOR_XRGB(255, 255, 255), *font, true);
        iYOffset -= iFontHeight;

        fm->DrawTextA("MAFIA II ", 25, iYOffset, D3DCOLOR_XRGB(179, 48, 48), *fm->GetFont("TitleUIFontBig"), true);
        fm->DrawTextA("Online", 25 + fm->GetTextWidthA(*fm->GetFont("TitleUIFontBig"), "MAFIA II "), iYOffset, D3DCOLOR_XRGB(255, 255, 255), *fm->GetFont("TitleUIFontBig"), true);
    }
}
